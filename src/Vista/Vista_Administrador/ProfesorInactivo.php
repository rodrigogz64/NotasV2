...
<head>
    ...
    <title>Control Profesores Inactivos</title>
</head>
<body>
    <?php
    ...
    <div class="main">
        ...
        <div class="encabezado_tabla">
            <h2>Control de Profesores Inactivos</h2>

            <table class='table table-bordered' id="tabla_profesor" class="table table-striped table-bodered">
